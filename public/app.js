...
// =========================================================================
// KLIK FOTO DAN NAMA DIMATIIN, DIPINDAH KE KLIK BADGE LEVEL
// =========================================================================
...
// FUNGSI INI DIBIARKAN SAJA (Meskipun gak dipanggil dari komentar, mungkin kepake di tempat lain)
            ...
            return `
                <div style="margin-bottom: 20px; padding: 0 20px; cursor: pointer;" onclick="${actionUrl}; closeUserProfileModal();">
                    <div style="display: flex; gap: 12px; margin-bottom: 8px; align-items: center;">
                        ...
                        <div style="flex: 1; min-width: 0;">
                            <div style="font-weight: 800; font-size: 13px; color: #3b8
