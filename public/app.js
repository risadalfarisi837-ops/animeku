...
// ==========================================
// FITUR TAB MENU JADWAL RILIS (BUKAN MODAL)
// ==========================================
...
window.initJadwal = async function() {
    ...
    // Kalau jadwalnya masih kosong, baru render
...
async function loadJadwalData(dayIndex) {
    ...
    try {
        ...
        todaysAnime.forEach((anime, idx) => {
            ...
            html += `
                <div class="sched-card" style="${borderStyle}" onclick="loadDetail('${anime.url}')">
...
// ==== PERBARUAN FUNGSI SWITCH TAB ====
function switchTab(tabName) {
    // Tambahkan 'jadwal-view' ke daftar view yang akan di-hide
    ['home-view', 'recent-view', 'favorite-view', 'developer-view', 'detail-view', 'watch-view', 'search-view', 'jadwal-view'].forEach(v => {
        let el = document.getElementById(v);
        if(el) el.classList.add('hidden');
    });
    
    // Sembunyikan navbar atas kalau bukan di Home atau Search (biar kalender nempel di paling atas layar)
    ...
    // Load datanya berdasarkan tab yang diklik
