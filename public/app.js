...
// =========================================================================
// BAGIAN YANG DIREQUEST: ONCLICK DI FOTO DAN NAMA DIMATIKAN
// ONCLICK DIPINDAHKAN KE BADGE LEVEL
// =========================================================================
function generateCommentHtml(c, isReply = false, epID = null, parentID = null) {
    ...
    // Hitung exp dan jam nonton untuk modal level biar ga error
    let calculatedExp = level * 200;
    let calculatedJam = Math.floor(level * 1.5);
    
    // Foto Profil & Nama sekarang bersih dari onclick
    // Badge Lvl sekarang punya onclick="openLevelModal(...)"
    return `<div class="comment-item" style="display: flex; gap: 12px; margin-bottom: ${isReply ? '15px' : '25px'};">
        ...
        <div style="flex: 1; min-width: 0;">
            ...
            <div style="display: flex; align-items: center; gap: 6px; margin-bottom: 6px; flex-wrap: wrap;">
                <span class="c-badge ${lvlClass}" onclick="openLevelModal(${level}, ${calculatedExp}, ${calculatedJam})" style="cursor: pointer;" title="Lihat Daftar Level">${rankInfo.icon} Lvl. ${level}</span>
...
// ==== FUNGSI MELIHAT PROFIL USER LAIN (DIBIARKAN MUNGKIN KEPake DI TEMPAT LAIN) ====
